...
module ButterflyNet
  ...
  class ErrorLog < ApplicationRecord
    has_many :occurrences, class_name: "ButterflyNet::ErrorOccurrence", dependent: :destroy
    ...
    scope :repeated, -> {
      subquery = ButterflyNet::ErrorOccurrence
        .select(:error_log_id)
        .group(:error_log_id)
        .having("COUNT(*) > 1")
      where(id: subquery)
    ...
    # @return [ButterflyNet::ErrorOccurrence] the created occurrence
    ...
    # @return [ButterflyNet::ErrorLog] the found or created error log
    ...
    # @return [ButterflyNet::Services::GitBlame::BlameResult, nil]
    ...
    def existing_blame_result
      ...
      ButterflyNet::Services::GitBlame::BlameResult.new(
        file: blame_file,
