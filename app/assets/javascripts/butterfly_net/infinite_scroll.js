  ...
  class InfiniteScroll {
    ...
    getStatusBadge(status) {
      const badges = {
        ...
        'in_progress': '<span class="inline-flex items-center gap-1 rounded-full font-medium transition-colors duration-base border bg-[var(--badge-warning-background-color)] text-[var(--badge-warning-text-color)] border-[var(--badge-warning-border-color)] text-sm px-3 py-1">In Progress</span>',
