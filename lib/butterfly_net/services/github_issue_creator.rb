  ...
  module Services
    ...
    class GitHubIssueCreator
      ...
      def initialize(access_token: nil, repo: nil)
        @access_token = access_token || ButterflyNet.configuration.github_access_token
        @repo = repo || ButterflyNet.configuration.full_repo_name

        @client = create_client if @access_token
      end

      # Creates a GitHub issue for an error log entry
      # @param error_log [ButterflyNet::ErrorLog] the error log record
